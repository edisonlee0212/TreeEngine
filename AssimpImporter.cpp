...
void AssimpImporter::ReadMaterial(std::string directory, aiMaterial* src, Material* dest, std::vector<Texture*>* texturesLoaded) {
...
inline std::vector<Texture*> AssimpImporter::LoadMaterialTextures(std::string directory, std::vector<Texture*>* texturesLoaded, aiMaterial* mat, aiTextureType type, Material_Type typeName) {
